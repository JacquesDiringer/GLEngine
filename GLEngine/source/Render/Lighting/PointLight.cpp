...
namespace GLEngine
{
	...
	void PointLight::Render(SceneManager * sceneManager, GraphicsResourceManager * graphicsResourceManager) const
	{
		...
		if (parentNode != nullptr)
		{
			...
			{
				shaderProgram = graphicsResourceManager->GetShader("C:\\Utils\\GLEngine\\resource\\Shaders\\DeferredShading\\Lighting\\PointLight.vert", "C:\\Utils\\GLEngine\\resource\\Shaders\\DeferredShading\\Lighting\\PointLight.frag");
			}
			else
			{
				shaderProgram = graphicsResourceManager->GetShader("C:\\Utils\\GLEngine\\resource\\Shaders\\DeferredShading\\Lighting\\PointLight.vert", "C:\\Utils\\GLEngine\\resource\\Shaders\\DeferredShading\\Lighting\\PointLightProjection.frag");
