...
namespace GLEngine
{
	...
	Texture2DRGB16F::Texture2DRGB16F(int width, int height, const void * data)
	...
	void Texture2DRGB16F::SetData(const void* data)
	{
	...
	void Texture2DRGB16F::Generate(int width, int height, const void * data)
	{
		glGenTextures(1, &_id);
